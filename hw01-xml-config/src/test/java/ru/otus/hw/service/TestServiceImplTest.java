...
class TestServiceImplTest {
    ...
    private static final String QUESTION_FORMAT = "%s. %s";
    ...
    void shouldPrintQuestionAndAnswersInOrder() {
        ...
        inOrder.verify(ioService).printFormattedLine(ANSWER_FORMAT, 'a', stubAnswers.get(0).text());
        inOrder.verify(ioService).printFormattedLine(ANSWER_FORMAT, 'b', stubAnswers.get(1).text());
        inOrder.verify(ioService).printFormattedLine(ANSWER_FORMAT, 'c', stubAnswers.get(2).text());
        inOrder.verify(ioService).printLine("");
